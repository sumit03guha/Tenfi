const abi2 = [
  ...
  },
  {
    ...
    inputs: [
      {
        indexed: false,
        internalType: 'contract TENTrollerInterface',
        name: 'oldTENTroller',
        type: 'address',
      },
      {
  ...
  },
  {
    constant: false,
    inputs: [
      { internalType: 'address', name: 'lendLikeDelegatee', type: 'address' },
    ],
    name: '_delegateLENDLikeTo',
    outputs: [],
    payable: false,
    stateMutability: 'nonpayable',
    type: 'function',
  ...
  {
    constant: false,
    inputs: [{ internalType: 'address', name: 'newCaller', type: 'address' }],
    name: 'changeReduceReserveCaller',
    outputs: [],
    payable: false,
    stateMutability: 'nonpayable',
    type: 'function',
