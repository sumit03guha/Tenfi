...
describe('TenLots', () => {
  ...
  describe('Deploy proxy and end to end testing', async () => {
    ...
    //     console.log('validated user reward : ', i, ' : ', res);
    ...
    //   await network.provider.send('evm_increaseTime', [69]);
    //   await network.provider.send('evm_mine');
    ...
    //   await tenLots
    //     .connect(owner)
    //     .editUserClaimTimeStamp(addresses[45], false, 0);
    ...
    //   await tenLots
    //     .connect(owner)
    //     .editUserClaimTimeStamp(addresses[247], false, 0);

    //   await network.provider.send('evm_increaseTime', [241]);
    //   await network.provider.send('evm_mine');
