...
describe('TenLots', () => {
  ...
  describe('Deploy proxy and end to end testing', async () => {
    ...
    //   await network.provider.send('evm_increaseTime', [73]);
    //   await network.provider.send('evm_mine');
    ...
    //   const testData = {
    //     balance: data2[25].balance,
    //     timestamp: (Date.now() / 1000).toFixed(0),
    //     level: data2[25].level,
    //     claimTimeStamp: data2[25].claimTimeStamp,
    //     pendingFee: data2[25].pendingFee,
    //     rewardDebt: data2[25].rewardDebt,
    //   };
    //   await tenLots
    //     .connect(owner)
    //     .enterUserIntoStaking([addresses[25]], [testData]);
    //   console.log('done');
    //   let user;
    //   await network.provider.request({
    //     method: 'hardhat_impersonateAccount',
    //     params: [addresses[25]],
    //   });
    //   user = await ethers.getSigner(addresses[25]);
    //   await tenLots
    //     .connect(owner)
    //     .editUserClaimTimeStamp(addresses[25], false, 0);

    //   await network.provider.send('evm_increaseTime', [133]);
    //   await network.provider.send('evm_mine');

    //   const obj = await tenLots.enterStakingStats(addresses[25]);
    //   console.log(obj.pendingFee.toString());
    ...
    //   const bal = await provider.getBalance(addresses[25]);
    //   const busdBal = await busdt.balanceOf(addresses[25]);
    //   const userReward = await tenLots.userRewardPerLot(addresses[25]);
    //   console.log(`userReward : ${ethers.utils.formatEther(userReward)}`);
    //   console.log(`account balance: ${ethers.utils.formatEther(bal)} Eth`);
    //   console.log(`BUSD balance: ${ethers.utils.formatEther(busdBal)} BUSD`);
    //   await tenLots.connect(user).claim({
    //     value: ethers.utils.parseUnits(obj.pendingFee.toString(), 'wei'),
    //   });
    //   const busdBal2 = await busdt.balanceOf(addresses[25]);
    //   console.log(
    //     `BUSD balance after: ${ethers.utils.formatEther(busdBal2)} BUSD`
    //   );

    //   const res = await tenLots.userEntered(addresses[25]);
    //   expect(res).to.be.false;
    // });
    ...
    //   await network.provider.send('evm_increaseTime', [193]);
    //   await network.provider.send('evm_mine');
    ...
    //   await network.provider.send('evm_increaseTime', [245]);
    //   await network.provider.send('evm_mine');
